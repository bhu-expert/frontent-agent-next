  ...
  if (!user) {
    return (
      <Box bg="gray.50" minH="100vh" py={12}>
        <Container maxW="2xl">
          <VStack align="stretch" gap={6} bg="white" p={8} borderRadius="2xl" boxShadow="sm">
            ...
            <Link as={NextLink} href="/login" display="inline-block">
              <Button bg="blue.600" color="white" size="lg" w="full" _hover={{ bg: "blue.700" }}>
                Sign In
              </Button>
            </Link>
          </VStack>
    ...
    <Box bg="gray.50" minH="100vh" py={12}>
      <Container maxW="2xl">
        <VStack align="stretch" gap={6} bg="white" p={8} borderRadius="2xl" boxShadow="sm">
          {/* Header */}
          <Box>
            <Heading as="h1" fontSize="2xl" fontWeight="700" color="red.600" mb={2}>
              Delete Account
            </Heading>
            <Text fontSize="14px" color="gray.600">
              Permanently delete your PostGini account and all associated data
            </Text>
          </Box>
          ...
          <Box bg="blue.50" p={4} borderRadius="lg" border="1px solid" borderColor="blue.100">
            ...
            <Box as="ul" ml={4} fontSize="13px" color="blue.800" lineHeight="1.8">
              <li>Your account will be immediately deactivated</li>
              <li>All data will be permanently deleted within 30 days</li>
              <li>Connected Facebook/Instagram accounts will be disconnected</li>
          ...
          <Box textAlign="center">
            <Link as={NextLink} href="/dashboard" color="gray.600" fontSize="14px">
          ...
          <Box textAlign="center">
            ...
            <Link
              href="mailto:support@postgini.com?subject=Account Deletion Assistance"
              color="blue.600"
              fontSize="13px"
            >
